...
public class LineReaderOutside implements Closeable {
   ...
   * @throws IOException
   */
  public LineReaderOutside(InputStream in) {
   ...
   * @throws IOException
   */
  public LineReaderOutside(InputStream in, int bufferSize) {
    this.in = in;
   ...
   * @throws IOException
   */
  public LineReaderOutside(InputStream in, Configuration conf) throws IOException {
   ...
   */
  public LineReaderOutside(InputStream in, byte[] recordDelimiterBytes) {
    this.in = in;
   ...
   * @throws IOException
   */
  public LineReaderOutside(InputStream in, Configuration conf,
